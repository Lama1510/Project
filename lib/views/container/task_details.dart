            ...
            IconButton(
                onPressed: () {
                  try {
                    ...
                    int taskID = DatabaseProvider.db.getTask(TaskList().dataBaseTasks[task_index].id) as int;
                    DatabaseProvider.db.insertSubTask(
                      SubTask(subtitle: subtaskController.text),
                      taskID
                    );
              ...
              children: [
                      ...
                      children: [
                        ...
                        Consumer<TaskList>(
                            builder: (context, value, child) => Text(
                                task_index != -1
                                    ? calculateDifference(
                                        value.tasks[task_index].date)
                                    : '',
                                style: TextStyle(
                                    color: Colors
                                        .black))) //Text(index != -1 ? MyHomePage.tasks[index].date.toString(): 'n'),
                      ],
                    ),
                    IconButton(
                      onPressed: () {},
                ...
                Row(
                  children: [
                    ...
                    Consumer<TaskList>(
                      builder: (context, value, child) => Text(
                          task_index != -1 ? value.tasks[task_index].title : '',
                          style: TextStyle(
                        ...
                        Expanded(
                          child: Consumer<TaskList>(
                            builder: (context, value, child) =>
                                ListView.builder(
                                    itemCount: value
                                            .tasks[task_index].subTasks.length +
                                        1,
                                    itemBuilder: (context, Index) => Row(
                                          ...
                                          children: [
                                            ...
                                            Text("data"),
                                            Text(value.tasks[task_index]
                                                    .subTasks.isEmpty
                                                ? "subtasks list is empty"
