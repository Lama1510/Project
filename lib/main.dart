...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, title: navbar() ),
                        ...
                        itemBuilder: (context, index) => GestureDetector(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed('/taskDetails', arguments: index);
                            },
                            child: Row(
                                        ...
                                        IconButton(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                //tasks[index].state="c";
                                                _completedTasks.add(
                                                    MyHomePage.tasks[index]);
                                                //print(tasks[index].state);
                                                MyHomePage.tasks.remove(
                                                    MyHomePage.tasks[index]);
                                              });
                                            },
                                            icon: Icon(
